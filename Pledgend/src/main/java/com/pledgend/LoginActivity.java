...
public class LoginActivity extends Activity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        Log.i("cheerspal", helper.getAuthUrl());
    ...
    private class PPWebViewClient extends WebViewClient
    {
        ...
        private void getProfile(String accessToken)
        {
            ...
            new AsyncConnection(new AsyncConnectionListener()
            {
                public void connectionDone(String result)
                {
                    setResult(RESULT_OK, new Intent().putExtra(AccessHelperConnect.DATA_PROFILE, result));
                    finish();
                }
    ...
    public static class AccessHelperConnect
    {
        ...
        private static final String URL_REDIRECT = "http://cheerspal.herokuapp.com";
         ...
         */
        public static AccessHelperConnect init(final String clientId, final String clientSecret)
        {
        ...
        public String getAuthUrl()
        {
            ...
            authUrlBuilder.append(URL_AUTHORIZE).append("?").append(PARAM_CLIENT_ID).append(valueClientId).append("&").append(PARAM_SCOPE).append(DATA_PROFILE).append("&").append(PARAM_REDIRECT_URI).append(Uri.encode(URL_REDIRECT)).append("&").append(PARAM_RESPONSE_TYPE).append(VALUE_RESPONSE_TYPE);
        ...
        public String getTokenServiceParameters(final String code)
        {
            ...
            paramsBuilder.append(PARAM_CLIENT_ID).append(valueClientId).append("&").append(PARAM_REDIRECT_URI).append(Uri.encode(URL_REDIRECT)).append("&").append(PARAM_GRANT_TYPE).append("&").append(PARAM_CLIENT_SECRET).append(valueClientSecret).append("&").append(PARAM_CODE).append(code);
        ...
        public String getProfileUrl(final String accessToken)
        {
            ...
            urlBuilder.append(URL_PROFILE).append("?").append(PARAM_SCHEMA).append(SCHEMA).append("&").append(PARAM_ACCESS_TOKEN).append(accessToken);
